...
Define PDF export capabilities for budgets and invoices, including server-side PDF generation via `@react-pdf/renderer`, shared template components, and the API endpoints that return PDF binaries.
